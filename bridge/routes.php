...
$router->New("SetAddressPrefired", "users/SetAddressPrefired");
$router->New("SetAddressNoPrefired", "users/SetAddressNoPrefired");
$router->New("deleteAddress", "users/deleteAddress");
$router->New("GetAddressesUser", "users/GetAddressesUser");
